...
import type { Config, Target, LogCollection } from "../../lib/api";
import { applyClaudeCodeProxy, restoreClaudeCodeProxy } from "../../lib/api";
    ...
    <div>
      ...
      <div className={styles.card}>
        ...
        <p style={{ color: "#6b7280", marginTop: 10, lineHeight: 1.7 }}>
          请求路径会直接拼接到选中目标的 Base URL 后，配置的 Headers 和 Body
          参数会自动合并进每次请求。
        </p>
      </div>
